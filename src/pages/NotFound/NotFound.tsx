...
export default function NotFound() {
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center'>
      ...
      <div className='absolute rotate-12 rounded bg-red-600 px-2 text-sm text-white'>Page Not Found</div>
      <button className='mt-5'>
        ...
        >
          <span className='absolute inset-0 translate-x-0.5 translate-y-0.5 bg-red-600 transition-transform group-hover:translate-x-0 group-hover:translate-y-0' />
